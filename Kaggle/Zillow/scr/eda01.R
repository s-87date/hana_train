...
#' 
## ---- warning=FALSE, fig.width=6, message=FALSE, echo=FALSE--------------
...
#' 
## ---- warning=FALSE, fig.width=5.5, message=FALSE, echo=FALSE------------
...
## ---- message=FALSE, warning=FALSE, fig.height=7-------------------------
...
#' 
## ----warning=FALSE, message=FALSE, fig.height=7--------------------------
